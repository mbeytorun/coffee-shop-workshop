...
public class ItemRestWebServiceTest {
    ...
    public void testCreateItem() throws Exception {
    	mockMvc.perform(post("/item")
                ...
                .content("{\"name\": \"Latte Java\", \"itemType\": \"Beverage\", \"price\": \"7\"}")
                .accept(MediaType.APPLICATION_JSON)
                .principal(new PrincipalImpl(UserServiceTest.USERNAME)))
                .andDo(print())
                .andExpect(status().isOk());

        Item item = itemService.findItemById(10L);
        assertTrue(item.getPrice().compareTo(new BigDecimal(7))==0);
    }
}
