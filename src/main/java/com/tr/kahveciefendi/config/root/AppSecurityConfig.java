...
import com.tr.kahveciefendi.app.security.AjaxAuthenticationSuccessHandler;
import com.tr.kahveciefendi.app.security.SecurityUserDetailsService;
...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .and()
            .formLogin()
            .defaultSuccessUrl("/resources/order.html")
